...
namespace Streams.Resources
{
    ...
    public class ResourceStream_should
    {
        ...
        private IEnumerable<string> GetKeysAndValues() => _data.SelectMany(z => new[] {z.Key, z.Value});
        ...
        public void SetUp()
        {
            _testStream = new TestStream(GetKeysAndValues());
        }

        [Test]
        public void ReadSimpleKey()
        {
            AssertReadKeyEqualsData("fileList.txt", _testStream);
        }

        [Test]
        public void ReadEmptyValue()
        {
            AssertReadKeyEqualsData("EmptyImage.png", _testStream);
        }

        [Test]
        public void ReadLongValue()
        {
            AssertReadKeyEqualsData("mapObjectsList.txt", _testStream);
        }

        [Test]
        public void ReadVeryLongValue()
        {
            AssertReadKeyEqualsData("ogreMagiAnimation.gif", _testStream);
        }

        [Test]
        public void ReadsCorrectly_WhenZeroValueInTheValue()
        {
            AssertReadKeyEqualsData("ogreMagi.png", _testStream);
        }

        [Test]
        public void ReadsCorrectly_WhenZeroValueInTheKey()
        {
            AssertReadKeyEqualsData("white\0Wolf.png", _testStream);
        }
        ...
        public void ReadsCorrectly_WhenSeparatorInTheKey()
        {
            ...
            _testStream = new TestStream(new[] {key, value});
            AssertReadKeyEqualsData(key, _testStream, value);
        }

        [Test]
        public void ReadsCorrectly_WhenSeparatorInTheValue()
        {
            AssertReadKeyEqualsData("wolf.png", _testStream);
        }
        ...
        {
            AssertThrowsExceptionWhenReadKey("unknown", _testStream);
        }
        ...
        public void ThrowsException_WhenUnexpectedEndOfStream_InKey(byte[] keyEnding)
        {
            ...
            _testStream = new TestStream(new[] {key}, keyEnding);
            AssertThrowsExceptionWhenReadKey(key, _testStream);
        }
        ...
        public void ThrowsException_WhenUnexpectedEndOfStream_InValue(byte[] valueEnding)
        {
            ...
            var streamBytes = keyBytes
                ...
                .Concat(valueEnding)
                .ToArray();
            _testStream = new TestStream(streamBytes);
            AssertThrowsExceptionWhenReadKey(key, _testStream);
        }
        ...
        {
            _testStream = new TestStream(GetKeysAndValues(), infinityMode: true);
            AssertReadKeyEqualsData("mapObjectsList.txt", _testStream);
        }
        ...
        {
            var reader = new ResourceReaderStream(_testStream, _data.Keys.FirstOrDefault());
        ...
        {
            AssertReadKeyEqualsData(key, stream, _data[key]);
        }
